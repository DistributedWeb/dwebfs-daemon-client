...
class StatusCommand extends Command {
  static description = 'Check the status of the DWebFs daemon.'
  static usage = 'status'
  ...
  async run () {
    try {
      ...
      console.log(`The DWebFs daemon is running:`)
      console.log()
      ...
      console.log(`  DWebFs Version:      ${status.hyperdriveVersion}`)
      console.log(`  Fuse Native Version:     ${status.fuseNativeVersion}`)
      console.log(`  DWebFs Fuse Version: ${status.hyperdriveFuseVersion}`)
      console.log()
      ...
      if (err.disconnected) {
        console.error('The DWebFs daemon is not running.')
      } else {
