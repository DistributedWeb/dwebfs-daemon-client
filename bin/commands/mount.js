...
class MountCommand extends DaemonCommand {
  ...
  static args = [
    DaemonCommand.drivePathArg({
      required: true,
      description: 'The path where the drive will be mounted (must be within ~/DWebFs)'
    }),
  ...
  static flags = {
    ...
    seed: flags.boolean({
      description: 'Seed the new drive on the DWebFs network (false by default for mounts)',
      required: false,
      default: false
    })
  }
